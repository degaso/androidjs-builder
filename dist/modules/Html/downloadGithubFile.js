...
function downloadGithubFile(githubFileLink, file, callback, showProgress) {
    ...
    if (githubFileLink.dir && githubFileLink.dir.length > 0) {
        downloadLink = (0, GitListDir_1.getFileDownloadLink)(githubFileLink.user, githubFileLink.repo, githubFileLink.dir, githubFileLink.file);
    }
    else {
        downloadLink = (0, GitListDir_1.getFileDownloadLink)(githubFileLink.user, githubFileLink.repo, githubFileLink.file);
    }
